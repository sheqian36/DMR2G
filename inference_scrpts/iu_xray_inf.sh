...
# MODEL_NAME=$1
MODEL_NAME="/home/shuchenweng/cz/oyh/output/seqdiffuseq/iu_xray_ckpts/debug/ema_0.9999_080000.pt"
OUT_DIR=$2
# SCHEDULE_PATH=$3
SCHEDULE_PATH="/home/shuchenweng/cz/oyh/output/seqdiffuseq/iu_xray_ckpts/debug/alpha_cumprod_step_70000.npy"
if [ -z "$OUT_DIR" ]; then
    OUT_DIR=${MODEL_NAME}
fi
...
NUM_SAMPLES=-1
SEQ_LEN=64
VAL_TXT="/home/shuchenweng/cz/oyh/data/seqdiffuseq/iu_xray/test"
TASK="iu_xray"
DATASET="iu_xray"
