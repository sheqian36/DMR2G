...
# CHECKPOINT_PATH="ckpts/${DSET}/iu_xray_${SEQ_LEN}_${LR}_${DIFFUSION_STEPS}_${LR_ANNEAL_STEPS}_${WARMUP}_${SCHEDULE_UPDATE_STRIDE}" #_src${SRC}_tgt${TGT}
CHECKPOINT_PATH="ckpts/${DSET}/iu_xray_${LR_ANNEAL_STEPS}"
...
DROPOUT=0.3
NUM_HEADS=8
CONFIG_NAME="./model/bart"   #"facebook/bart-base"
