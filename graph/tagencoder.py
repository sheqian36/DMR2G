...
def init_tokenizer():
    tokenizer = BertTokenizer.from_pretrained('/home/shuchenweng/cz/oyh/model/genie/bert-base-uncased')
...
class TagEncoder(nn.Module):
    ...
    def __init__(self,dropout):
        ...
        med_config = '/home/shuchenweng/cz/oyh/blip-seqdiffuseq/blip/bert_config.json'
        # med_config = 'configs/tag_config_sci.json'
        encoder_config = BertConfig.from_json_file(med_config)
        encoder_config.encoder_width = 768
        self.bert = BertModel(config=encoder_config, add_pooling_layer=False, SKG_know=True)
        # self.bert = BertModel.from_pretrained('/home/shuchenweng/cz/oyh/model/genie/bert-base-uncased',config=encoder_config, add_pooling_layer=False, SKG_know=True)
    ...
    def get_tag_embeds(self,x, device):
        # x = ' '.join(x)
        # return ids
        x = self.tokenizer(x, padding='max_length', truncation=True, max_length=64,
